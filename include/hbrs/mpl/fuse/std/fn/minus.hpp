...
#ifndef HBRS_MPL_FUSE_STD_FN_MINUS_HPP
#define HBRS_MPL_FUSE_STD_FN_MINUS_HPP

#include <hbrs/mpl/config.hpp>
#include <hbrs/mpl/fuse/std/detail/operators.hpp>
#include <boost/hana/tuple.hpp>

#define HBRS_MPL_FUSE_STD_FN_MINUS_IMPLS boost::hana::make_tuple(                                                      \
...
#endif // !HBRS_MPL_FUSE_STD_FN_MINUS_HPP
