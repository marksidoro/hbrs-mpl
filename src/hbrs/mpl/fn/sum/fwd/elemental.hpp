...
#ifndef HBRS_MPL_FN_SUM_FWD_ELEMENTAL_HPP
#define HBRS_MPL_FN_SUM_FWD_ELEMENTAL_HPP
...
struct sum_impl_smcs_el_matrix {
	template <
		typename Matrix,
...
struct sum_impl_smrs_el_matrix {
	template <
		typename Matrix,
		typename std::enable_if_t<
...
struct sum_impl_el_dist_matrix_columns {
	template <
		typename DistMatrix,
		typename std::enable_if_t<
...
#define HBRS_MPL_FN_SUM_IMPLS_ELEMENTAL boost::hana::make_tuple(                                                       \
		hbrs::mpl::detail::sum_impl_smcs_el_matrix{},                                                                  \
		hbrs::mpl::detail::sum_impl_smrs_el_matrix{},                                                                  \
		hbrs::mpl::detail::sum_impl_el_dist_matrix_columns{}                                                           \
	)

#endif // !HBRS_MPL_FN_SUM_FWD_ELEMENTAL_HPP
