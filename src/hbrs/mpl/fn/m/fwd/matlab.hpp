...
#ifndef HBRS_MPL_FN_M_FWD_MATLAB_HPP
#define HBRS_MPL_FN_M_FWD_MATLAB_HPP
...
#define HBRS_MPL_FN_M_IMPLS_MATLAB boost::hana::make_tuple(                                                            \
		hbrs::mpl::detail::m_impl_emxArray{},                                                                          \
		hbrs::mpl::detail::m_impl_ml_matrix{}                                                                          \
	)

#endif // !HBRS_MPL_FN_M_FWD_MATLAB_HPP
