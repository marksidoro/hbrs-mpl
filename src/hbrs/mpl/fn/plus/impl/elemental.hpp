...
#ifndef HBRS_MPL_FN_PLUS_IMPL_ELEMENTAL_HPP
#define HBRS_MPL_FN_PLUS_IMPL_ELEMENTAL_HPP
...
>
auto
plus_impl_el_matrix_el_matrix::operator()(el_matrix<Ring> a, el_matrix<Ring> const& b) const {
...
>
decltype(auto)
plus_impl_el_dist_matrix_expand_expr_el_dist_matrix::operator()(
...
>
auto
plus_impl_el_matrix_scalar::operator()(el_matrix<Ring> a, Ring const& b) const {
...
#endif // !HBRS_MPL_FN_PLUS_IMPL_ELEMENTAL_HPP
