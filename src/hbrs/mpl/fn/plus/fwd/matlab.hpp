...
#ifndef HBRS_MPL_FN_PLUS_FWD_MATLAB_HPP
#define HBRS_MPL_FN_PLUS_FWD_MATLAB_HPP
...
#define HBRS_MPL_FN_PLUS_IMPLS_MATLAB boost::hana::make_tuple(                                                         \
		hbrs::mpl::detail::plus_impl_ml_matrix_scalar{},                                                               \
		hbrs::mpl::detail::plus_impl_ml_matrix_ml_matrix{}                                                             \
	)

#endif // !HBRS_MPL_FN_PLUS_FWD_MATLAB_HPP
