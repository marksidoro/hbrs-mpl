...
#ifndef HBRS_MPL_FN_PLUS_FWD_ELEMENTAL_HPP
#define HBRS_MPL_FN_PLUS_FWD_ELEMENTAL_HPP
...
struct plus_impl_el_matrix_el_matrix {
	template <
		typename Ring,
...
struct plus_impl_el_dist_matrix_expand_expr_el_dist_matrix {
	template <
...
struct plus_impl_el_matrix_scalar {
	template <
		typename Ring,
		typename std::enable_if_t< 
			!std::is_const< Ring >::value && !std::is_lvalue_reference<Ring>::value
...
#define HBRS_MPL_FN_PLUS_IMPLS_ELEMENTAL boost::hana::make_tuple(                                                      \
		hbrs::mpl::detail::plus_impl_el_matrix_el_matrix{},                                                            \
		hbrs::mpl::detail::plus_impl_el_dist_matrix_expand_expr_el_dist_matrix{},                                      \
		hbrs::mpl::detail::plus_impl_el_matrix_scalar{}                                                                \
	)

#endif // !HBRS_MPL_FN_PLUS_FWD_ELEMENTAL_HPP
