...
#ifndef HBRS_MPL_FN_SIZE_FWD_STD_HPP
#define HBRS_MPL_FN_SIZE_FWD_STD_HPP
...
HBRS_MPL_DEC_FO_TRY_METHOD(size_impl_std_vector, hana::ext::std::vector_tag, size)
...
#endif // !HBRS_MPL_FN_SIZE_FWD_STD_HPP
