...
#ifndef HBRS_MPL_FN_SIZE_FWD_HBRS_MPL_HPP
#define HBRS_MPL_FN_SIZE_FWD_HBRS_MPL_HPP
...
HBRS_MPL_DEC_FO_TRY_METHOD(size_impl_ctsav,    ctsav_tag,    length)
HBRS_MPL_DEC_FO_TRY_METHOD(size_impl_rtsav,    rtsav_tag,    length)
HBRS_MPL_DEC_FO_TRY_METHOD(size_impl_submatrix,   submatrix_tag,   size)
HBRS_MPL_DEC_FO_TRY_METHOD(size_impl_subsequence, subsequence_tag, size)
HBRS_MPL_DEC_FO_TRY_METHOD(size_impl_sm,       sm_tag,       size)
HBRS_MPL_DEC_FO_TRY_METHOD(size_impl_smc,      smc_tag,      length)
HBRS_MPL_DEC_FO_TRY_METHOD(size_impl_smcs,     smcs_tag,     length)
HBRS_MPL_DEC_FO_TRY_METHOD(size_impl_smr,      smr_tag,      length)
HBRS_MPL_DEC_FO_TRY_METHOD(size_impl_smrs,     smrs_tag,     length)
HBRS_MPL_DEC_FO_TRY_METHOD(size_impl_sms,      sms_tag,      length)
HBRS_MPL_DEC_FO_TRY_METHOD(size_impl_srv,      srv_tag,      size)
...
#endif // !HBRS_MPL_FN_SIZE_FWD_HBRS_MPL_HPP
