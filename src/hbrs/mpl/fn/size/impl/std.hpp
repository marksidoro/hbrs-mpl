...
#ifndef HBRS_MPL_FN_SIZE_IMPL_STD_HPP
#define HBRS_MPL_FN_SIZE_IMPL_STD_HPP
...
size_impl_std_array::operator()(S&& s) const {
...
>
constexpr decltype(auto)
size_impl_std_tuple::operator()(S&& s) const {
...
#endif // !HBRS_MPL_FN_SIZE_IMPL_STD_HPP
