...
#ifndef HBRS_MPL_FN_VARIANCE_FWD_MATLAB_HPP
#define HBRS_MPL_FN_VARIANCE_FWD_MATLAB_HPP
...
#define HBRS_MPL_FN_VARIANCE_IMPLS_MATLAB boost::hana::make_tuple(                                                         \
		hbrs::mpl::detail::variance_impl_ml_matrix{}                                                                       \
	)

#endif // !HBRS_MPL_FN_VARIANCE_FWD_MATLAB_HPP
