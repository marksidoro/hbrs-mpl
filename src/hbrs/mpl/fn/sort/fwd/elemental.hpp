...
#ifndef HBRS_MPL_FN_SORT_FWD_ELEMENTAL_HPP
#define HBRS_MPL_FN_SORT_FWD_ELEMENTAL_HPP
...
#ifdef HBRS_MPL_ENABLE_ELEMENTAL
struct sort_impl_el_eig_result {
	template<
		typename Vector,
		typename Matrix,
		typename Predicate,
	...
	>
	auto
	operator()(eig_result<Vector,Matrix> const&, Predicate &&) const;
...
#define HBRS_MPL_FN_SORT_IMPLS_ELEMENTAL boost::hana::make_tuple(                                                      \
		hbrs::mpl::detail::sort_impl_el_eig_result{}                                                                   \
	)

#endif // !HBRS_MPL_FN_SORT_FWD_ELEMENTAL_HPP
