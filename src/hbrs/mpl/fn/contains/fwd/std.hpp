...
#ifndef HBRS_MPL_FN_CONTAINS_FWD_STD_HPP
#define HBRS_MPL_FN_CONTAINS_FWD_STD_HPP
...
#define HBRS_MPL_FN_CONTAINS_IMPLS_STD boost::hana::make_tuple(                                                        \
		hbrs::mpl::detail::contains_impl_std_vector{},                                                                 \
		hbrs::mpl::detail::contains_impl_std_tuple{}                                                                   \
	)

#endif // !HBRS_MPL_FN_CONTAINS_FWD_STD_HPP
