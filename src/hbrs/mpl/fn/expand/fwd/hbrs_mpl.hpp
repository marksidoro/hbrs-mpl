...
#ifndef HBRS_MPL_FN_EXPAND_FWD_HBRS_MPL_HPP
#define HBRS_MPL_FN_EXPAND_FWD_HBRS_MPL_HPP
...
#define HBRS_MPL_FN_EXPAND_IMPLS_HBRS_MPL boost::hana::make_tuple(                                                     \
		hbrs::mpl::detail::expand_impl_srv{}                                                                           \
	)

#endif // !HBRS_MPL_FN_EXPAND_FWD_HBRS_MPL_HPP
