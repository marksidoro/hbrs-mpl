...
#ifndef HBRS_MPL_DT_DMD_RESULT_FWD_HPP
#define HBRS_MPL_DT_DMD_RESULT_FWD_HPP
...
constexpr auto to_dmd_result = hana::to<dmd_result_tag>;
...
#endif // !HBRS_MPL_DT_DMD_RESULT_FWD_HPP
