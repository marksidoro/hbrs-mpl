...
#ifndef HBRS_MPL_DETAIL_IS_BRACES_CONSTRUCTIBLE_IMPL_HPP
#define HBRS_MPL_DETAIL_IS_BRACES_CONSTRUCTIBLE_IMPL_HPP
...
#endif // !HBRS_MPL_DETAIL_IS_BRACES_CONSTRUCTIBLE_IMPL_HPP
